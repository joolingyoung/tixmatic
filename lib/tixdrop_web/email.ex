defmodule TixdropWeb.Email do
  ...
  2. Remove the lib/tixdrop/mailer.ex file
  ...
  #{TixdropWeb.Endpoint.url()}/confirm?key=#{key}
  """)
    |> Mailer.deliver_now()
  end
  ...
  def reset_request(address, key) do
    ...
    |> text_body(
      ...
      #{TixdropWeb.Endpoint.url()}/password_resets/edit?key=#{key}
      """
    )
    |> Mailer.deliver_now()
  end
